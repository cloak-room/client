...
<img alt="default view, login button highlighted for clarity" src="./login.png" style="width:100%; max-width: 20em;"/>

First, **select your name from the list**, then click the **LOGIN button**

<img alt="login screen, highlighted for clarity" src="./login_screen.png" style="width:100%; max-width: 20em;"/>

You may verify that you have logged in successfully by the presence of the **LOGOUT** button or the **+/add** button

<img alt="login screen highlighted for clarity" src="./verify_login.png" style="width:100%; max-width: 20em;"/>

<p align="right">(<a href="#user-guide">back to top</a>)</p>
...
<img alt="the back button" src="./back_button.png" style="width:100%; max-width: 20em;"/>
...
<img alt="searching and filtering options" src="./search_filter.png" style="width:100%; max-width: 20em;"/>
...
<img alt="add button highlighted for clarity" src="./addbutton.png" style="width:100%; max-width: 20em;"/>
...
<img alt="add items screen when empty" src="./add_items_empty.png" style="width:100%; max-width: 20em;"/>
...
<img alt="sample add items screen with mandatory fields filled" src="./add_items_form_fill.png" style="width:100%; max-width: 20em;"/>

**Press the item** or **discount** you want to add. _This will dismiss the menu_

<img alt="sample add items screen with mandatory fields filled" src="./add_item_menu.png" style="width:100%; max-width: 20em;"/>

You may remove items added to the cart by pressing their unique **DELETE** button

<img alt="cart, delete from cart button highlighted" src="./delete_from_cart.png" style="width:100%; max-width: 20em;"/>

To add a photo of the items being collected, press the **PHOTO** button

<img alt="add photo button" src="./add_photo_button.png" style="width:100%; max-width: 20em;"/>

This will open your system's camera dialogue. _For example (android)_

<img alt="camera dialogue example" src="./camera_dialogue.png" style="width:100%; max-width: 20em;"/>
...
<img alt="view photo button" src="./view_photo.png" style="width:100%; max-width: 20em;"/>

If the details have been added correctly, and you are happy with the photo, you can add the item using the **SUBMIT** button

<img alt="submit button" src="./submit.png" style="width:100%; max-width: 20em;"/>
...
<img alt="sample error message" src="./sample_error.png" style="width:100%; max-width: 20em;"/>
...
<img alt="sample error message" src="./collect_payment.png" style="width:100%; max-width: 20em;"/>
...
<img alt="item added successfully status message (green)" src="./added_successfully.png" style="width:100%; max-width: 20em;"/>
...
<img alt="click the row to expand it" src="./expand_row.png" style="width:100%; max-width: 20em;"/>

Then, at the bottom of the expanded row, press the **REFUND button**
<img alt="click the refund buttont" src="./refund_button.png" style="width:100%; max-width: 20em;"/>

When prompted, press **CONFIRM** to process the refund

<img alt="confirm the refund" src="./confirm_refund.png" style="width:100%; max-width: 20em;"/>
...
<img alt="press the edit button" src="./edit_button.png" style="width:100%; max-width: 20em;"/>
...
<img alt="press the submit button to submit once changes are made" src="./edit_items_submit_button.png" style="width:100%; max-width: 20em;"/>
...
<img alt="item updated successfully" src="./item_updated_successfully.png" style="width:100%; max-width: 20em;"/>
...
<img alt="press the collect button" src="./collect_button.png" style="width:100%; max-width: 20em;"/>

Press the **CONFIRM button** to confirm the collection

<img alt="press the confirm button" src="./confirm_collection.png" style="width:100%; max-width: 20em;"/>

If the collection was successful, a green success message will appear at the top of the screen

<img alt="item collected successfully" src="./collection_successful.png" style="width:100%; max-width: 20em;"/>
